        ...
        execute: function () {
            ...
            WasmModule = class WasmModule {
                ...
                emitNames(array) {
                    ...
                    log(section.data, array.position, this.functionCount, "num func names");
                    // section.data.writeUnsignedLEB128(this.functionCount);
                    section.data.writeUnsignedLEB128(0);
                    // let fn = this.firstFunction;
                    // while (fn != null) {
                    //     let name = getWasmFunctionName(fn);
                    //     // log(section.data, array.position, null, " - func name");
                    //     log(section.data, array.position, section.data.position, name);
                    //     section.data.writeWasmString(name);
                    //     log(section.data, array.position, fn.localCount, "local count");
                    //     section.data.writeUnsignedLEB128(fn.localCount); // No local variables for now
                    //     fn = fn.next;
                    // }
                    wasmFinishSection(array, section);
                }
